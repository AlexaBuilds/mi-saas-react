...
function Mensaje(props){
    ...
    return(
        //IMPORTANTE: En HTML normal usaríamos 'class', pero en React es OBLIGATORIO usar 'className'.
        //Las llaves {claseCSS} le dicen a React: "Oye, esto no es un texto normal, es una variable JS".
